...
from app.core.views import MyRegisterFormView, MainPageView, ProfileUpdateView, LoginView, LogoutView, NumberUpdateView, CarUpdateView, ModelUpdateView, ProfileDetailView
